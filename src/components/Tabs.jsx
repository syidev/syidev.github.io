    ...
    render() {
        return (
            <ul className="nav nav-tabs" role="tablist">
				...
				<li role="presentation"><a href="#javascript" aria-controls="javascript" role="tab" data-toggle="tab">JS, jQuery <span className="badge">{this.props.javascript}</span></a></li>
